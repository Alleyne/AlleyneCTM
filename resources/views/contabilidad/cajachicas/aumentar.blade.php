				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false">
					...
					<div>
						...
						<!-- end widget edit box -->
							...
							{{ Form::open(array('class' => 'form-horizontal', 'route' => 'aumentarCajachicaStore')) }}		
                		...
                		{{ Form::hidden('cajachica_id', $cajachica_id) }}
									...
									<!-- Form Name -->
										<legend>Aumentar saldo de Caja Chica</legend>
                        ...
                        <div class="col-md-9">
                        	...
                        	<p>{!! $errors->first('fecha', '<li style="color:red">:message</li>') !!}</p> 
						        ...
						        {{Form::button('Salvar', array(
						            ...
						            'data-title' => 'Aumentar saldo de Caja chica',
						            'data-message' => 'Esta seguro(a) que desea aumentar el saldo de la Caja chica?',
						            'data-btntxt' => 'SI, aumentar saldo',
