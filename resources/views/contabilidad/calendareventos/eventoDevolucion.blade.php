			...
			<article class="col-sm-12 col-md-12 col-lg-12">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false">
					...
					<header>
						...
						<h2>Devolver depositos y cancelar reservacion</h2>
					...
					<div>
						...
						{{-- 	{{dd($dato->toArray())}} --}}
							...
							<div class="widget-body">
								...
								{{ Form::open(array('class' => 'form-horizontal','route' => array('eventoDevolucionStore', $dato->id))) }}
									<fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
													<div class="input-group">
														<input type="text" name="fecha" placeholder="Seleccione la fecha de devolucion!" class="form-control datepicker" data-dateformat="yy/mm/dd" value={{ old('fecha') }}>
				            ...
				            <div class="form-group transaccionNo">
				              ...
				              <div class="col-md-10">
						        ...
						        {{Form::button('Salvar', array(
						            ...
						            'data-message' => 'Esta seguro(a) que desea proceder con la devolucion del monto depositado por servacion de amenidades?',
						            'data-btntxt' => 'Si, proceder con la devolucion',
