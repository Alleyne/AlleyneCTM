				...
				<div class="jarviswidget jarviswidget-color-orange" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false">
					...
					<div>
						...
						<!-- end widget edit box -->
							...
							{{ Form::open(array('class' => 'form-horizontal', 'route' => 'pagosnoids.store')) }}		
									<fieldset>
	 									{{ csrf_field() }}
                
									<!-- Form Name -->
										<legend>Registrar pago no identificado</legend>

                    <div class="form-group">
                        <label class="col-md-3 control-label">Fecha</label>
                        <div class="col-md-9">
													<div class="input-group">
														<input type="text" name="fecha" placeholder="Seleccione la fecha del pago no identificado..." class="form-control datepicker" data-dateformat="yy/mm/dd" value={{ old('fecha') }}>
                      	...
                      	<p>{!! $errors->first('banco_id', '<li style="color:red">:message</li>') !!}</p> 											
											</div>
										</div>	
											...
											<div class="col-md-9">
												{{ Form::text('doc_no', old('doc_no'),
													array(
													    'class' => 'form-control',
													    'id' => 'doc_no',
													    'placeholder' => 'Escriba el numero del transaccion...',
														'autocomplete' => 'off',
													))
												}} 
