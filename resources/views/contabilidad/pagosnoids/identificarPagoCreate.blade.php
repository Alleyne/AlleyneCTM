			...
			<article class="col-sm-12 col-md-12 col-lg-12">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false">
					...
					<header>
						...
						<h2>Identificar pagos no identificados</h2>
					</header>
					...
					<div>
						...
						<!-- end widget edit box -->
							...
							{{ Form::open(array('class' => 'form-horizontal', 'route' => 'identificarPagoStore')) }}		
									<fieldset>
	 								{{ csrf_field() }}
                	{{ Form::hidden('pagosnoid_id', $pagosnoid_id) }}
									
									<!-- Form Name -->
										<legend>Identificar a que unidad pertenece el pago</legend>
