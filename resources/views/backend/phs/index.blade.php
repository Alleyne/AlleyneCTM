					...
					<div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="true" data-widget-deletebutton="false">
						...
						<header>
							...
							<div class="widget-toolbar">
								<a href="{{ URL::route('phs.create') }}" class="btn btn-success"><i class="fa fa-plus"></i> Agregar Ph</a>
							</div>
						</header>
										...
										@foreach ($datos as $dato)
											<tr>
												...
												<td col width="100px" align="right">
													<ul class="demo-btns">
														<li>
															<a href="{{ URL::route('phs.show', $dato->id) }}" class="btn btn-info btn-xs"><i class="fa fa-search"></i></a>
														</li>				
														<li>
															<a href="{{ URL::route('phs.edit', $dato->id) }}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
														</li>
														<li>
															{{ Form::open(array('route' => array('phs.destroy', $dato->id), 'method' => 'delete', 'data-confirm' => 'Deseas borrar este Ph '. $dato->nombre. ' permanentemente?')) }}
																<button type="submit" href="{{ URL::route('phs.destroy', $dato->id) }}" class="btn btn-danger btn-xs"><i class="fa fa-times"></i></button>
															{{ Form::close() }}										
														</li>
													</ul>
												</td>
