			...
			<form class="form-horizontal">
				...
				<fieldset>
					<div class="form-group">
						...
						<div class="col-md-10">
							<input class="form-control input-sm" name="nombre" type="text" readonly value="{{ $bloque->nombre }}">
						</div>
					</div>					
				...
				<div class="form-actions">
				   	<a href="{{ URL::route('indexblqplus', $jd->id) }}" class="btn btn-primary btn-large">Regresar</a>
				</div>			
			</form>
