...
@section('title', '| Editar Junta Directiva')
							...
							{{ Form::model($dato, array('class' => 'form-horizontal', 'method' => 'put', 'route' => array('jds.update', $dato->id))) }}
									<fieldset>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												{{ Form::text('nombre', $dato->nombre, array('class' => 'form-control input-sm', 'title' => 'Escriba el nombre del Ph...', 'autocomplete' => 'off')) }}
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												{{ Form::text('pais', $dato->pais, array('class' => 'form-control input-sm', 'title' => 'Escriba el país...', 'autocomplete' => 'off')) }}
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												{{ Form::text('provincia', $dato->provincia, array('class' => 'form-control input-sm', 'title' => 'Escriba la provincia...', 'autocomplete' => 'off')) }}
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												{{ Form::text('distrito', $dato->distrito, array('class' => 'form-control input-sm', 'title' => 'Escriba el distrito...', 'autocomplete' => 'off')) }}
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												{{ Form::text('corregimiento', $dato->corregimiento, array('class' => 'form-control input-sm', 'title' => 'Escriba el corregimiento...', 'autocomplete' => 'off')) }}
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												{{ Form::text('comunidad', $dato->comunidad, array('class' => 'form-control input-sm', 'title' => 'Escriba la comunidad...', 'autocomplete' => 'off')) }}
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												{{ Form::text('calle', $dato->calle, array('class' => 'form-control input-sm', 'title' => 'Escriba la calle...', 'autocomplete' => 'off')) }}
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												{{ Form::text('telefono', $dato->telefono, array('class' => 'form-control input-sm', 'title' => 'Escriba el teléfono...', 'autocomplete' => 'off')) }}
									...
									<div class="form-actions">
										...
										<a href="{{ URL::route('jds.show', 1) }}" class="btn btn-large">Cancelar</a>
									</div>
							{{ Form::close() }}
							</div>
							<!-- end widget content -->
				...
				<div class="jarviswidget jarviswidget-color-blue" id="wid-id-1" data-widget-editbutton="false" data-widget-deletebutton="false">
					...
					<div>
						...
						<div class="widget-body">
				         	...
				         	{{ Form::open(array('route' => array('subirImagenJd', $dato->id),'files'=>true)) }}
								<div class="form-actions">
				         		<div>
									{{ Form::file('file') }}
								</div>						
