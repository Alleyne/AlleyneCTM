...
@section('content')
    ...
    <div class="container content">
        <div class="row team margin-bottom-20">
            <div class="col-md-4">
                <div class="thumbnail-style">
                    <img alt="" src="assets/frontend/img/Directivos/1.jpg" class="img-responsive">
        ...
        <div class="headline"><h2>Account Directors</h2></div>
        <div class="row team margin-bottom-20">
            <div class="col-sm-4">
                <div class="thumbnail-style">
                    <img alt="" src="assets/frontend/img/Directivos/3.jpg" class="img-responsive">
            ...
            <div class="col-sm-4">
                <div class="thumbnail-style">
                    <img alt="" src="assets/frontend/img/Directivos/2.jpg" class="img-responsive">
            ...
            <div class="col-sm-4">
                <div class="thumbnail-style">
                    <img alt="" src="assets/frontend/img/Directivos/4.jpg" class="img-responsive">
