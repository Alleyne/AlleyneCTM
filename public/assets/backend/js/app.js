...
$(document).ready(function() {
	...
	$('#ask_1 a').click(function(e) {
		...
		// ask verification
		$.SmartMessageBox({
			title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> Desea continuar<span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
			content : $.logoutMSG || "Completamente seguro que desea continuar?",
			buttons : '[No][Yes]'
	...
	$('#ask_2 a').click(function(e) {
		...
		// ask verification
		$.SmartMessageBox({
			title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> Anular pago<span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
			content : $.logoutMSG || "Esta usted seguro(a) que desea anular el presente pago?",
			buttons : '[No][Yes]'
	...
	$('#ask_3 a').click(function(e) {
		...
		// ask verification
		$.SmartMessageBox({
			title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> Cerrar periodo contable<span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
			content : $.logoutMSG || "Completamente seguro que desea cerrar definitivamente el presente periodo contable?",
			buttons : '[No][Yes]'
	...
	$('#ask_4 a').click(function(e) {
		...
		// ask verification
		$.SmartMessageBox({
			title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> Eliminar pago<span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
			content : $.logoutMSG || "Completamente seguro que desea eliminar definitivamente el presente pago?",
			buttons : '[No][Yes]'
	...
	$('#ask_5 a').click(function(e) {
		...
		// ask verification
		$.SmartMessageBox({
			title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> Contabilizar factura<span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
			content : $.logoutMSG || "Completamente seguro que desea contabilizar la presente factura?",
			buttons : '[No][Yes]'
	...
	$('#ask_6 a').click(function(e) {
		...
		// ask verification
		$.SmartMessageBox({
			title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> Contabilizar detalle de pago<span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
			content : $.logoutMSG || "Completamente seguro que desea contabilizar la presente detalle de pago?",
			buttons : '[No][Yes]'
