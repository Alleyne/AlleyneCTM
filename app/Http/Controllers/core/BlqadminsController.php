...
use Session, Grupo, Validator, Image, DB;
...
class BlqadminsController extends Controller {
	...
	public function indexblqadmin($bloque_id)
	{
		...
		return view('core.blqadmins.indexblqadmin')
					->with('datos', $datos)
	...
	public function store()
	{
		...
		try {		
			...
			if ($validation->passes())
			{
				...
				$tabla = 'blqadmins';
				$registro = $dato->id;
				$accion = 'Vincula administrador de bloque';
	...
	************************************************************************************/	
	public function desvincularblqdmin($id) {
		...
		try {		
			...
			$tabla = 'blqadmins';
			$registro = $dato->id;
			$accion = 'Desvincula administrador de bloque';
			Sity::RegistrarEnBitacoraEsp($detalle, $tabla, $registro, $accion);
