...
class DiariocajasController extends Controller
{
    ...
    public function show($id)
    {
      ...
      $desembolsoEfectivos= Detallepagofactura::where('detallepagofacturas.fecha', $fecha)
                ...
                ->get(['detallepagofacturas.id as pagoNo','detallepagofacturas.trans_no','trantipos.id as trantipo_id', 'trantipos.nombre as trantipo','codigo','ctmayores.detalle','credito as monto']);
