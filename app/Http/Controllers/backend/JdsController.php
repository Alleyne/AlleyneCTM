...
class JdsController extends Controller
{
	...
	public function index()
	{
        ...
        //return response()->json($datos->toArray());
 		return view('backend.jds.index')->with('datos', $datos);
	}	
	...
	public function show($id)
	{
	    ...
	    if(!empty($dato)) {
			...
			return view('backend.jds.show')->with('dato', $dato);
		}
	    else {
   ...
   /*************************************************************************************
	...
	{
        return view('backend.jds.create');
	}     
	...
	{
		return view('backend.jds.edit')->with('dato', Jd::find($id));
	}
