...
class BloquesController extends Controller {
	...
	public function indexblqplus()
	{
	    ...
	    return view('backend.bloques.indexblqplus')->with('jd', $jd)
	...
	public function showblqplus($bloque_id)
	{
	    ...
	    return view('backend.bloques.showblqplus')->with('jd', $jd)
	    										  ->with('bloque', $bloque)
	...
	{
	    return view('backend.bloques.createblq')
					->with('jd_id', $jd_id);        			
	} 
	...
	{
		return view('backend.bloques.edit')
